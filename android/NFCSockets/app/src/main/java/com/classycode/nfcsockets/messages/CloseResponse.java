 ...
 */
public class CloseResponse extends SocketResponse {
    ...
    public void fromApdu(byte[] apdu) throws IOException {
        ...
        if (in.readByte() != MSG_SOCKET || in.readByte() != MSG_SOCKET_CLOSE_RESPONSE) {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("CloseResponse{");
